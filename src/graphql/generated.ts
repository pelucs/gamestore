...
export type ProductManyWhereInput = {
  ...
  /** All values containing the given string. */
  departament_contains?: InputMaybe<Scalars['String']>;
  /** All values ending with the given string. */
  departament_ends_with?: InputMaybe<Scalars['String']>;
  /** All values that are contained in given list. */
  departament_in?: InputMaybe<Array<Scalars['String']>>;
  /** All values that are not equal to given value. */
  departament_not?: InputMaybe<Scalars['String']>;
  /** All values not containing the given string. */
  departament_not_contains?: InputMaybe<Scalars['String']>;
  /** All values not ending with the given string */
  departament_not_ends_with?: InputMaybe<Scalars['String']>;
  /** All values that are not contained in given list. */
  departament_not_in?: InputMaybe<Array<Scalars['String']>>;
  /** All values not starting with the given string. */
  departament_not_starts_with?: InputMaybe<Scalars['String']>;
  /** All values starting with the given string. */
  departament_starts_with?: InputMaybe<Scalars['String']>;
...
export type GetProductBySlugQuery = { __typename?: 'Query', product?: { __typename?: 'Product', id: string, name: string, price: string, slug: string, brand: string, category: string, description: string, departament: string, image: { __typename?: 'Asset', url: string } } | null };

export type GetProductsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetProductsQuery = { __typename?: 'Query', products: Array<{ __typename?: 'Product', id: string, name: string, price: string, slug: string, brand: string, category: string, description: string, departament: string, image: { __typename?: 'Asset', url: string } }> };
